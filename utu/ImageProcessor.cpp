...
static void _copy(QString sourceFile, QString destFile);
...
public:
    ...
    void process(QString sourceFile, ImageProcessor::ImageAlgorithm algorithm)
    {
        ...
        QString destFile = QString("%1/%2_%3").arg(QStandardPaths::writableLocation(QStandardPaths::DataLocation))
                .arg((int)algorithm).arg(fi.fileName());
        //QString destFile = QString(".local/share/utu.binli/%2_%3").arg((int)algorithm).arg(fi.fileName());
